      ...
      <div class="modal-body">
        <form action="{{route('calendario-guardar')}}" method="post">
          ...
          <div class="col-md-12">
            ...
            <textarea type="text" class="form-control" name="contenido" required rows="3" oncopy="return false" onpaste="return false" onkeydown="pulsar(event)"></textarea>
            ...
            <input type="datetime-local" class="form-control" name="inicio" id="fechainicio" required>
        ...
        <select class="form-control" name="detalles" id="opcion" onchange="seleccionar()">
