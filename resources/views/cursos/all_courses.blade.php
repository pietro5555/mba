...
<div class="section-landing mt-3" style="background: linear-gradient(to bottom, #222326 50%, #1C1D21 50.1%);">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="row">
                    ...
                    @if($contador <= 3) <div class="col-md-4" style="margin-top: 20px;">
                        ...
                        <img src="{{ asset('uploads/images/courses/covers/'.$recommended->thumbnail_cover) }}"
                            class="card-img-top img-prox-events" alt="...">
                        @else
                        <img src="{{ asset('uploads/images/courses/covers/default.jpg') }}"
                            class="card-img-top img-prox-events" alt="...">
                        @endif
                        <div class="card-img-overlay clearfix">
                            ...
                            <div class="row ml-0 d-flex h-100">
                                <div class="col-md-9 my-auto" style="margin-bottom: 7px !important">
                                    <h6 class="col-sm w-100 pl-0" style="font-size: 14px"><img
                                            src="{{ asset('images/icons/video-player-green.svg') }}" alt=""
                                            height="20px" width="20px"> <a
                                            href="{{ route('courses.show', [$recommended->slug, $recommended->id]) }}"
                                            class="text-white"> {{$recommended->title}}</a></h6>
                                </div>
        ...
        <div class="carousel-item">
            <div class="row">
                ...
                @if($segundo >= 4 && $segundo <= 6) <div class="col-md-4" style="margin-top: 20px;">
                    @if (!is_null($recommended->thumbnail_cover))
                    <img src="{{ asset('uploads/images/courses/covers/'.$recommended->thumbnail_cover) }}"
                        class="card-img-top img-prox-events" alt="...">
                    @else
                    <img src="{{ asset('uploads/images/avatar/default.jpg') }}" class="card-img-top img-prox-events"
                        alt="...">
                    @endif
                    <div class="card-img-overlay clearfix">
                        ...
                        <div class="row ml-0 d-flex h-100">
                            <div class="col-md-9 my-auto" style="margin-bottom: 7px !important">
                                <h6 class="col-sm w-100 pl-0" style="font-size: 14px"><img
                                        src="{{ asset('images/icons/video-player-green.svg') }}" alt="" height="20px"
                                        width="20px"> <a
                                        href="{{ route('courses.show', [$recommended->slug, $recommended->id]) }}"
                                        class="text-white"> {{$recommended->title}}</a></h6>
                            </div>
    ...
    <div class="carousel-item">
        <div class="row">
            ...
            @if($tercero >= 7 && $tercero <= 9) <div class="col-md-4" style="margin-top: 20px;">
                @if (!is_null($recommended->thumbnail_cover))
                <img src="{{ asset('uploads/images/courses/covers/'.$recommended->thumbnail_cover) }}"
                    class="card-img-top img-prox-events" alt="...">
                @else
