...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-1 img-course-cat border-0">
            ...
            <img src="{{ asset('uploads/images/courses/covers/'.$curso->thumbnail_cover) }}"
                class="border-0 card-img-top img-opacity p-2" alt="..."
            ...
            <div class="card-img-overlay clearfix">
                <div class="row ml-0 d-flex h-100">
                    <div class="col-md-9 my-auto" style="margin-bottom: 0px !important">
                        <h6 class="col-sm w-100 pl-0" style="font-size: 14px"><i
                                class="text-success fa fa-play-circle"></i> <a
                                href="{{ route('courses.show', [$curso->slug, $curso->id]) }}"
                                class="text-white">{{ $curso->title }}</a></h6>
                    ...
                    <div class="col-md-3 my-auto" style="margin-bottom: 0px !important">
                        <h6 class="text-white w-100">
                            <i class="far fa-user-circle text-center">
                                <p style="font-size: 10px;">{{ $curso->views }}</p>
                            </i>
                        </h6>
                    </div>
                </div>
