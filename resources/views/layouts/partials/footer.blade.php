                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-2 text-center text-white" style="margin-top: 20px;">
                                    <img src="{{ asset('images/logo.png') }}" style="" class="img-logo-footer"> <strong>2020 My Business Academy Pro</strong> All Rigth Reserved
                            </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-2 mt-3 mb-3">
            <div class="row">
                ...
                <div class="col-md-4 pt-2 badge-danger">
                    <div class="row">
                        <div class="col-md-4">
                           <a href="" class="btn btn-social-icon btn-facebook"><img src="{{ asset('images/icons/facebook.svg') }}" height="20px" width="20px"></a>
                           <a href="" class="btn btn-social-icon btn-twitter"><img src="{{ asset('images/icons/twitter.svg') }}" height="20px" width="20px"></a>
                           <a href="" class="btn btn-social-icon btn-instagram"><img src="{{ asset('images/icons/instagram.svg') }}" height="20px" width="20px"></a>
                        </div>
                    </div>
                </div>
            </div>
