  ...
  <div class="col-md-12" style="background-color: #1C1D21; margin-bottom: 40px;">
    <div class="col-md-8 offset-md-2" style="margin-top: 50px;">
      ...
      <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
           <div class="col-md-4">
              <img src="{{ asset('nosotros/nosotros/05.png') }}" class="card-img" alt="..." style="height: 100%;">
           </div>
       ...
       <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
           ...
           <div class="col-md-4">
              <img src="{{ asset('nosotros/nosotros/06.png') }}" class="card-img" alt="..." style="height: 100%;">
           </div>
         </div>
       </div>
       ...
       <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
           <div class="col-md-4">
              <img src="{{ asset('nosotros/nosotros/07.png') }}" class="card-img" alt="..." style="height: 100%;">
           </div>
    ...
    <div class="col-md-12" style="background-color: #FFFFFF;">
     ...
     <div class="col-md-8 offset-md-2" style="padding-bottom: 80px; padding-top: 50px;">
      <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
            <div class="col-md-4" style="min-height: 200px; background-image: url('{{ asset('nosotros/nosotros/09.png') }}'); background-size: cover; background-position: top;">
            ...
            <div class="col-md-4" style="min-height: 200px; background-image: url('{{ asset('nosotros/nosotros/10.png') }}'); background-size: cover; background-position: top;">
            	<div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;">
                    <div class="mt-auto">
                        <div class="new-course-title">
                        	Innovación
             ...
             <div class="col-md-4" style="min-height: 200px; background-image: url('{{ asset('nosotros/nosotros/08.png') }}'); background-size: cover; background-position: top;">
             	<div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;">
                    <div class="mt-auto">
                        <div class="new-course-title">
                        	Crecimiento
      ...
      <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
            <div class="col-md-4">
            	<img src="{{ asset('nosotros/nosotros/11.png') }}" style="min-height: 200px;width: 100%;">
            	<div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;">
                    <div class="mt-auto">
                        <div class="new-course-title">
                        	Calidad
            ...
            <div class="col-md-4">
            	<img src="{{ asset('nosotros/nosotros/12.png') }}" style="min-height: 200px;width: 100%;">
            	<div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;">
                    <div class="mt-auto">
                        <div class="new-course-title">
                        	Eficacia
             ...
             <div class="col-md-4">
             	<img src="{{ asset('nosotros/nosotros/13.png') }}" style="min-height: 200px;width: 100%;">
             	<div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;">
                    <div class="mt-auto">
                        <div class="new-course-title">
                        	Trascendencia
...
<div class="col-md-12" style="background-color: #1C1D21;">
    ...
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
            <div class="col-md-6">
            	<img src="{{ asset('nosotros/nosotros/josegordo.png') }}" style="height: 400px;width: 100%;">
            </div>
    ...
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
          <div class="col-md-6" style="color: #fff; background-color: #1c1d21;">
            ...
            <div class="col-md-6">
            	<img src="{{ asset('nosotros/nosotros/marianalopez.png') }}" style="height: 400px;width: 100%; padding-bottom: 80px;">
            </div>
          </div>
        </div>
    </div>
...
<div class="col-md-10 offset-md-1">
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;">
        <div class="row no-gutters">
           <div class="col-md-4" style="background-color: #EDEDED;">
              <img src="{{ asset('nosotros/nosotros/16.png') }}" class="card-img" alt="..." style="max-height: 300px;">
             <div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;"> 
               <div class="mt-auto">
    ...
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important;  margin-top: 80px;">
        <div class="row no-gutters">
          ...
          <div class="col-md-4" style="background-color: #EDEDED;">
              <img src="{{ asset('nosotros/nosotros/17.png') }}" class="card-img" alt="..." style="max-height: 300px;">
              <div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;"> 
               <div class="mt-auto">
    ...
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important; margin-top: 80px;">
        <div class="row no-gutters">
           <div class="col-md-4" style="background-color: #EDEDED;">
              <img src="{{ asset('nosotros/nosotros/18.png') }}" class="card-img" alt="..." style="max-height: 300px;">
              <div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;"> 
               <div class="mt-auto">
                  <div class="new-course-title" style="background-color: #333; padding: 8px; float: right; color: #2A91FF;">
                    Mirela Vuckovic
    ...
    <div class="card mb-3" style="max-width: 100%; margin-bottom: 0rem!important; padding-bottom: 80px; margin-top: 80px;">
        <div class="row no-gutters">
          ...
          <div class="col-md-4" style="background-color: #EDEDED;">
              <img src="{{ asset('nosotros/nosotros/19.png') }}" class="card-img" alt="..." style="max-height: 300px;">
              <div class="card-img-overlay d-flex flex-column" style="color: #fff; text-align: center;"> 
               <div class="mt-auto">
