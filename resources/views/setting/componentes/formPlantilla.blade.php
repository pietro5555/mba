        ...
        <div class="box-body">
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla de Correo Bienvenida</h3>
                        </div>
                    </div>
                    <div class="box-body">
                        <form class="" action="{{route('setting-save-plantilla')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">Las Variables de abajo son dinamica, al colocar esas variables se
                                    colocara la
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla de Correo Pago</h3>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla de Compra</h3>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla de Pago Compra</h3>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla Liquidacion</h3>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        <div class="box-title">
                            <h3>Configuración de la Plantilla Prospeccion</h3>
                        </div>
                    </div>
                    <div class="box-body">
