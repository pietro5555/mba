    ...
    <div class="box box-info">
        ...
        @endif
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="{{$item['img']}}" alt="{{$item['titulo']}}" style=" width: 200px; height: 200px; border-radius: 50%;">
                    <div class="caption">
                        <h3 id="title{{$item['ID']}}" class="title-producto">{{$item['titulo']}}</h3>
                        ...
                        <h3>
                            ...
                            <span class="label pull-right price">
                                Precio: <b id="precio{{$item['ID']}}">
                                    ...
                                    {{$moneda->simbolo}} {{$item['valor']}}
                                    @else
                                    {{$item['valor']}} {{$moneda->simbolo}}
                                    @endif
                                </b>
                            </span>
                        </h3>
                    ...
                    @if($settings->btc == 0)
                        <a href="{{request()->root()}}/link/link?producto_id={{$item['ID']}}" class="btn green btn-block">Ver Producto</a>
                ...
                <a onclick="seleccionar('{{$item['ID']}}','{{['titulo']}}','{{$item['meta_value']}}')" class="btn btn-info btn-block">Comprar {{env('CRYPTO')}}</a>
                        
                <a onclick="seleccionarTB('{{$item['ID']}}','{{['titulo']}}','{{$item['meta_value']}}')" class="btn btn-primary btn-block">Comprar TB</a>  
                    @endif
                    </div>
                </div>
            </div>
