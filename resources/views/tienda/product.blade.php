...
<div class="col-xs-6">
  <div class="box box-info">
    ...
    <div class="box-body">
      <form method="POST" action="{{ route('tienda-product-save') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="col-sm-12">
          ...
          <input class="form-control" type="number" name="puntos" min="0"
            required/>
  ...
  <div class="box box-info">
    ...
    <div class="box-body">
        <div class="col-xs-12 col-md-12">
                <div class="thumbnail">
                    <img src="http://core360.com.br/shop/skin/adminhtml/default/default/lib/jlukic_semanticui/examples/assets/images/wireframe/image.png" alt="" id="blah" class="circular">
                    <div class="caption">
                        <h3 id="titleprevio" class="title-producto">
                        </h3>
                        
                        <p class="text-justify" id="textdescrip"></p>
                        ...
                        <h3>
                            ...
                            <span class="label pull-right price" id="normal" style="display:none;">
                                Precio: <b id="precio">
                        ...
                        <a href="#" class="btn green btn-block" style="margin-top: 20px;">Ver Producto</a>
